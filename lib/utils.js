...
const parseHit = (hit) => {
  ...
  return {
    ...
    NIP_gender: _source['Provider Gender Code'],
    NIP_degree: _source['Provider Credential Text'],
    NIP_address: _source['Provider First Line Business Practice Location Address'],
    NIP_city: _source['Provider Business Practice Location Address City Name'],
    NIP_state: _source['Provider Business Practice Location Address State Name'],
    NIP_zipCode: _source['Provider Business Practice Location Address Postal Code'],
  }
};
